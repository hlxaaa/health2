<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FoodType.aspx.cs" Inherits="WebApplication1.Webs.FoodType1" %>
            ...
            <div class="row" id="divMain3">
                <table class="table table-striped table-hover">
                   ...
                   <%--     <tr style="background-color: white;">
                            ...
                            <td class="td-edit">
                                <a class="btn-edit" style="text-decoration: none;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img class="btn-edit fl" src="/Images/recipe/icon-edit.png" /><font class="modal-title fl" id="myModalLabel">菜品分类编辑
                    </font>
                    <div class="fc"></div>
                </div>
